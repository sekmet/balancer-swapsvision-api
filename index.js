...
app.get('/data/v1/all/swaps/:sortby/:limit', db.getAllSwaps)
...
app.get('/data/v1/toptokensranking/:sortby/:limit', db.getTopTokensRanking)
app.get('/data/v1/toppairsranking/:sortby/:limit', db.getTopPairsRanking)
app.get('/data/v1/swapstats/:limit', db.getSwapsStats)
app.get('/data/v1/liquiditystats/:limit', db.getLiquidityStats)
app.get('/data/v1/liquiditydailystats/:limit', db.getDailyLiquidityStats)
